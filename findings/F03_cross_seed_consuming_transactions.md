...
## Core Evidence
- `evidence/csv/cross_seed_consuming_transactions_2026-04-06.csv`
- `evidence/csv/cross_seed_consuming_transactions_annotated_2026-04-08.csv`
- `evidence/csv/cross_seed_consuming_transactions_summary_2026-04-06.json`
...
## Reproduction
- `queries/validation/cross_entity_merge_validation.sql`

...
- Attempted connection to `192.168.86.118:5432` as `codex_audit`
- Server response: `FATAL: no pg_hba.conf entry for host "192.168.86.135", user "codex_audit", database "cexplorer_replica"`
